  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String,WidgetBuilder>{
        ...
        '/DaftarPertemuan': (BuildContext context)=> DaftarPertemuan(username: emailUser,),
        '/CustomNavBar': (BuildContext context)=> CustomNavBar(username: emailUser),
        '/Profile': (BuildContext context)=> Profile(),
        '/ForumLearning': (BuildContext context)=> ForumLearning()
      },
    );
  }
}
